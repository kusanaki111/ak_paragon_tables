...
BEGIN
	...
	FOREACH entry IN ARRAY paragon_data LOOP
		INSERT INTO "lottery" VALUES (i, paragon_id, (i - MOD(i, 6)) / 6, entry.weekday, MOD(i, 6), entry.item_id, entry.max_stack, entry.drop_rate, entry.notify, entry.get_only, entry.shining_hint, entry.jack_pot);
		i := i + 1;
	END LOOP;
